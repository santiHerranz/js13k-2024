...
// 🛡🧲💊💣💰💳🟡
export const backButton = { label: '⏪', fontSize: 80, posY: 1800 };
export const gameIcons = { wallet: '💰', enemy: '👾' }; //heart: '🧡', , diamond: '💎'

export const HINTS = [
  gameIcons.enemy + " destroy all emenies",
  "Collect 🟡 coins",
  "Bonus if collect > 13",
  "Avoid number 13 💣",
];
...
export const GameConfig = {
  ...
  playerSuperWeaponReloadTime: 16,
  playerShieldTime: 8,
  playerShieldReloadTime: 20,
  ...
  levelEnemyCount: [8, 10, 15, 20, 27, 36, 50, 66, 90, 120, 160, 220, 300].map(_ => _ * 1.5),
